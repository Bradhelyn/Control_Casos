<template>
  <div class="tipos-casos-container">
    ...
    <NuevoFaltaModal 
      :show="showNuevoFaltaModal" 
      :tipos-casos="tiposCasos" 
      :tipo-seleccionado="tipoSeleccionado"
      :modo-edicion="modoEdicion"
      @close="showNuevoFaltaModal = false" 
      @submit="agregarNuevaFalta"
      @update="actualizarFalta" 
    />
    ...
    <div class="table-container">
      <div class="filters">
        <div class="search-field">
          ...
          <input type="text" placeholder="Buscar falta..." v-model="searchQuery" />
        </div>
        
        <div class="filter-options">
          <button class="nuevo-tipo-button" @click="openNuevoFaltaModal()">
            <div class="button-content">
              <div class="icon-circle">
                <span class="material-icons">add</span>
              </div>
              <span class="button-text">Nueva falta</span>
            </div>
      ...
      <table class="tipos-table">
        <thead>
          <tr>
            ...
            <th class="column-tipo">Tipo de Falta</th>
...
<script>
import NuevoFaltaModal from './NuevoFaltaModal.vue';
...
export default {
  ...
  methods: {
    ...
    openNuevoFaltaModal() {
      ...
      this.showNuevoFaltaModal = true;
    },
  
    // Alias para mantener compatibilidad con posibles llamadas existentes
    abrirNuevoFaltaModal() {
      this.openNuevoFaltaModal();
    },
    ...
    agregarNuevaFalta(nuevoTipo) {
      // Validar que los campos requeridos no estén vacíos
      if (!nuevoTipo || !nuevoTipo.descripcion || nuevoTipo.descripcion.trim() === '' ||
          !nuevoTipo.tipoFalta || nuevoTipo.tipoFalta.trim() === '') {
        console.warn('Se intentó agregar una falta con campos requeridos vacíos');
        return; // No agregar registros incompletos
      }
    ...
    actualizarFalta(tipoActualizado) {
      ...
      if (index !== -1) {
        ...
        this.tiposCasos[index] = {
          ...this.tiposCasos[index],
          tipoFalta: tipoActualizado.tipoFalta,
    ...
    confirmarEliminacion() {
      ...
      // Eliminar la falta
      console.log(`Eliminar falta con ID: ${this.tipoAEliminar}`);
